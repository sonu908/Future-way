...
const Footer = () => {
  return (
    <footer className="p-4  bg-[#E9F8F3] md:p-8 lg:p-10">
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <ul className="flex flex-wrap justify-center gap-5 items-center mb-6 text-gray-900 dark:text-white">
          <li>
            <a href="#" className=" text-[#20B486]  mr-4 hover:underline md:mr-6 "><FaInstagram /></a>
          </li>
          <li>
            <a href="#" className="mr-4 text-[#20B486]  hover:underline md:mr-6"><FaLinkedin /></a>
          </li>
          <li>
            <a href="#" className="mr-4 text-[#20B486]  hover:underline md:mr-6 "><FaTwitter /></a>
          </li>
        </ul>
