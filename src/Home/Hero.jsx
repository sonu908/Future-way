        ...
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0'>
            <div className='flex flex-col justify-start gap-4'>
                <p className="text-5xl font-lighter text-gray-900 sm:text-8xl mt-24 font-abrill-fatface">
                    my<span className='text-[#e6d9b6] font-abrill-fatface'>future</span>way
                </p>
                <p className='py-2 mt-9 text-xl text-[#8A826D] font-medium'>"A bright future begins here"</p>
                ...
                <br />
                <span className="text-[#8A826D] text-sm">Connect with us and embark on a journey where your educational dreams become a reality.
                <br /> A bright future begins here at myFutureWay.</span>
                </p>
                <div className='bg-white'>

                    <button className='rounded-md border p-4 hover:bg-[#8A826D] hover:text-white' onClick={scrollToContact}>
                        Contact us
                    </button>
                </div>
            </div>
